          ...
          <div className="d-flex flex-column flex-md-row align-items-center ">
            <div className="d-flex flex-column text-md-end text-center me-md-5">
              ...
              <p className="text text-md-end text-center text-light fs-4 fw-bold">
                ...
                d'exprimer ma créativité de 100 000 manières différentes.
                J'apprends et grandis constamment dans ce domaine, et je suis
                impatient de voir où cela me mènera."
              </p>
              <a href="#contacts">
        ...
        <Carousel className="mt-5">
          ...
          <Carousel.Item>
            ...
            <Carousel.Caption>
              <h3>App&tito</h3>
              <p>
                L'application pour trouver les meilleurs restaurants en Italie
              </p>
              <Button
          ...
          <Carousel.Item>
            ...
            <Carousel.Caption>
              <h3>musiXplosion</h3>
              <p>L'application pour écouter des extraits musicaux</p>
              <Button
          ...
          <div className="row mx-0">
            <div className="col-12 col-md-6 mx-0 d-flex justify-content-center align-items-center">
              <button
                ...
                onClick={() => window.open("https://wa.me/33671401750")}
              >
                <FontAwesomeIcon
                  icon={faPhone}
                  size="xl"
